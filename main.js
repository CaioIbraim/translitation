...
aLangKeys['pt-br']['home']='Inicio';
aLangKeys['pt-br']['peoples']='Pessoas >>';
aLangKeys['pt-br']['all_list']='Lista completa';
aLangKeys['pt-br']['online']='Online';
aLangKeys['pt-br']['articles']='Artios >>';
aLangKeys['pt-br']['js']='JavaScript';
aLangKeys['pt-br']['php']='PHP';
aLangKeys['pt-br']['html']='HTML';
aLangKeys['pt-br']['css']='CSS';
aLangKeys['pt-br']['contact_us']='Entre em contato';
aLangKeys['pt-br']['welcome']='Bem-vindo visitante';
aLangKeys['pt-br']['a_man']='Um homem suborna um coelho com próteses perversas para fugir com ele em um veleiro através de uma ambulância. Subornando Koalas para permanecerem ilegalmente em um só lugar. As árvores me ancoram no lugar. / Sua mãe dirige a ambulância, mas a cidade está mais longe do que parece.';
